...
public class Country {
	...
	public Country(String countryCode, List<String> currencies) {
		super();
		this.alpha3Code = countryCode;
	...
	protected void setAlpha3Code(String alpha3Code) {
	...
	protected void setCurrencies(List<String> currencies) {
		this.currencies = currencies;
	}
